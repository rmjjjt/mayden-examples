...
console.log("You're on the mic, what's your beef?");
console.log("");


rl.setPrompt("The dopest MC in the whole, wide room> ");
rl.prompt();
rl.on('line', function(cmd) {
	...
	if (cmd === "/help") {
		...
		console.log(bot.getUserlets("localuser"));
		...
		let reply = (bot && bot.ready)
			? bot.reply("localuser", cmd)
			: "ERR: The Fresh Prince of Bot Air Not Ready Yet";
		console.log("The Fresh Prince of Bot Air>", reply);
	}
